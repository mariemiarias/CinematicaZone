    ...
    render() {
        return ( 
            ...
            <div className = "box_footer" >
                ...
                <i class = "fa-solid fa-paper-plane" > </i> Pago Contra Entrega </a>
            </div>
            <div className = "box_footer" >
                <h2> Contactenos </h2> 
                <a href = "https://api.whatsapp.com/send/?phone=573105367582&text&type=phone_number&app_absent=0" >
                <i class = "fa-brands fa-whatsapp" > </i> 3212202983 </a>
                <a href = "https://api.whatsapp.com/send/?phone=573105367582&text&type=phone_number&app_absent=0" >
                <i class = "fa-brands fa-whatsapp" > </i> 3105367582 </a> 
                <a href = "#" >
                <i class = "fa-sharp fa-solid fa-phone" > </i> 33212202983 </a> 
                <a href = "#" >
                <i class = "fa-sharp fa-solid fa-phone" > </i> 3105367582 </a>
                <a href = "https://accounts.google.com/" >
                <i class = "fa-solid fa-envelope" > </i> mariemiliana2023@gmail.com </a>
                <a href = "https://accounts.google.com/" >
                <i class = "fa-solid fa-envelope" > </i> ac91.bastidas@gmail.com </a>
                <a href = "https://goo.gl/maps/fBydmutqQSyKMpS89" >
                <i class = "fa-solid fa-map-location-dot" > </i> Carrera 81H # 73d - 11sur </a> 
            </div>

            </div> 
            <div className = "box_copyright" >
            <hr/>
            <p> Todos los derechos reservados® 2023 <b> CinematicaZone </b> </p> 
            </div> 
            </footer>
            </div>
        );
